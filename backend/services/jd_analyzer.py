...
1. skills_required: 技能列表（如 ["Python", "FastAPI", "PostgreSQL"]）
2. experience_level: 经验级别，必须是以下之一: "Junior", "Mid", "Senior", "Lead"
3. salary_estimate: 薪资估算（如果原文没有，根据市场情况估算范围，如 "80000-120000 AUD/年"）
4. key_requirements: 关键要求列表（3-5 条最重要的要求）
5. industry: 行业分类（如 "科技", "金融", "医疗" 等）
